export const StringsPortuguese = {
  ...
  pageCodeDescription:
    'Você precisa digitar um código válido para iniciar a pesquisa e ajudar sua empresa a ser melhor.',
  informerTitle: 'Seja bem-vindo à pesquisa em pulso da Fluxo.',
  informerDescription:
